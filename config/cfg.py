...
BASE_DIR = os.environ.get('FINANCIAL_AI_BASE_DIR', '/root/autodl-tmp/.v_scratchs/llm/20_financial_AI_expert/')
DATA_PATH = BASE_DIR + "data/"
NUM_PROCESSES = min(64, max(1, os.cpu_count() or 1))  # Cap at 64 to avoid resource exhaustion
